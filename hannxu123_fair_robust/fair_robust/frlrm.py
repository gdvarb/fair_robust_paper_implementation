...
def main(args):
    ...
    for now_epoch in range(1, maxepoch + 1):
        ...
        frl_train_remargin(h_net, ds_train, ds_valid, optimizer, now_epoch, configs,
                              configs1, device, delta0, delta1, rate1, rate2, lmbda, beta, lim)
        lr_scheduler.step(now_epoch)
        print('................................................................................')
    torch.save(h_net.state_dict(), 'frl_final_model_' + args.model + '_' + str(args.seed) + '_' + 
                   str(args.rate1) + str(args.rate2) + '_' + str(args.bound0) + '_' + 
                   str(args.bound1) + '_' + str(args.lim) + '.pt')
